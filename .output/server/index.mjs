...
import { w as toNodeListener, e as destr, z as useRuntimeConfig, x as trapUnhandledNodeErrors, t as setupGracefulShutdown, y as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
